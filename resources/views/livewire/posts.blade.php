                    ...
                    <table class="table-fixed w-full ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$post->tanggal}}</td>
                                <td>
                                    <button wire:click="edit({{$post->id}})" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">
                                        Edit
                                    </button>
                                    <button wire:click="delete({{$post->id}})" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">
                                        Delete
                                    </button>
                                </td>
                            </tr>
