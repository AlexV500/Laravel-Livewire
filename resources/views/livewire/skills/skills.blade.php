    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg px-4 py-4">
                    ...
                    <div class="flex mb-4">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <input wire:model="search" type="text" class="shadow apperance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Search ...">
                        </div>
                    </div>
                    ...
                    <table class="table-fixed w-full ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$skill->skill}}</td>
                                <td>
                                    <button wire:click="edit({{$skill->id}})" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">
                                        Edit
                                    </button>
                                    <button wire:click="delete({{$skill->id}})" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">
                                        Delete
                                    </button>
                                </td>
                            </tr>
